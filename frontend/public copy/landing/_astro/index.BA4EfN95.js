import {g as Y} from "./_commonjsHelpers.CqkleIqs.js";
function X(p, v) {
...
function Z() {
    ...
    function S(e, t, n, u, o) {
        ...
        if (s)
            ...
            S(o, t, n, "", function(a) {
                return a;
            })) : o != null && (g(o) && (o = G(o, n + (!o.key || s && s.key === o.key ? "" : ("" + o.key).replace(V, "$&/") + "/") + e)),
            t.push(o)),
            1;
        if (s = 0,
        u = u === "" ? "." : u + ":",
    ...
    r.cloneElement = function(e, t, n) {
        ...
        var u = O({}, e.props)
          ...
          , s = e._owner;
        if (t != null) {
            if (t.ref !== void 0 && (c = t.ref,
            s = w.current),
            t.key !== void 0 && (o = "" + t.key),
            e.type && e.type.defaultProps)
                var f = e.type.defaultProps;
            for (i in t)
                A.call(t, i) && !D.hasOwnProperty(i) && (u[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
        }
...
export {te as R, ee as a, ne as e, L as r};
